 ...
 *
 * v3.2.8 keeps the read-only V3 Real Future Candidate Capture Readiness page in shared legacy Ops navigation, adds sanitized evidence snapshot, EDXEIX payload preview/dry-run preflight, and expired candidate safety regression audit support, controlled live-submit readiness checklist support, single-row live-submit design draft support, authorization packet support, real-format demo mail fixture preview support, and adds no new live-submit pathway; V0 remains untouched and live submit remains disabled. The shell follows the established Ops Home palette:
