 ...
 *
 * v3.2.3 keeps the read-only V3 Real Future Candidate Capture Readiness page in shared legacy Ops navigation, adds sanitized evidence snapshot and EDXEIX payload preview/dry-run preflight support, and adds no new live-submit pathway; V0 remains untouched and live submit remains disabled. The shell follows the established Ops Home palette:
