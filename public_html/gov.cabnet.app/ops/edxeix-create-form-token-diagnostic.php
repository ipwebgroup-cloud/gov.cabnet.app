<?php
/**
 * gov.cabnet.app — Ops EDXEIX create-form token diagnostic v3.2.37.
...
try {
    ...
    $result = [
        'ok' => true,
        'version' => 'v3.2.37-edxeix-create-form-token-diagnostic',
        'classification' => [
...
<div class="wrap">
  <section class="card hero <?= $ok ? 'ok' : '' ?>">
    ...
    <p class="muted">v3.2.37 — read-only GET of the EDXEIX create form. No EDXEIX POST, no AADE call, no queue job, no normalized booking write, no live config write.</p>
