 ...
 *
 * v2.2 update:
 * - Adds a prominent link to the new EDXEIX-style Ops Home.
 * - Does not redirect /ops/index.php.
 */
...
<main class="wrap">
    ...
    <section class="card new-home-card">
        <h2>New EDXEIX-style Ops Home is available</h2>
        <p>The polished operator interface is now available at <code>/ops/home.php</code>. This original guided console remains available and has not been redirected.</p>
        <div>
            <?= od_badge('NEW ENTRY POINT', 'warn') ?>
            <?= od_badge('NO REDIRECT', 'good') ?>
            <?= od_badge('READ ONLY', 'good') ?>
        </div>
        <div class="actions">
            <a class="btn gold" href="/ops/home.php">Open New EDXEIX-style Ops Home</a>
            <a class="btn green" href="/ops/test-session.php">Open Test Session</a>
            <a class="btn light" href="/ops/admin-control.php">Open Admin Control</a>
        </div>
    </section>
