...
<div class="gov-shell">
    <aside class="gov-sidebar">
        ...
        <p>Read-only operator decision assistant</p>
        <div class="gov-side-group"><div class="gov-side-group-title">Workflow control</div><a class="gov-side-link active" href="/ops/preflight-review.php">Preflight Review</a><a class="gov-side-link" href="/ops/test-session.php">Test Session Control</a><a class="gov-side-link" href="/ops/evidence-report.php">Evidence Report</a><a class="gov-side-link" href="/ops/readiness.php">Readiness</a><a class="gov-side-link" href="/ops/mappings.php">Mappings</a><a class="gov-side-link" href="/ops/jobs.php">Jobs</a></div>
        <div class="gov-side-note">Read-only / dry-run operator console. Live EDXEIX submission remains blocked.</div>
    </aside>
    <div class="gov-content">
        <div class="gov-page-header">
            <div>
                <h1 class="gov-page-title">Βοηθός ελέγχου προπτήσης</h1>
                <div class="gov-breadcrumbs">Αρχική / Διαχειριστικό / Βοηθός ελέγχου προπτήσης</div>
            </div>
            <div class="gov-tabs"><a class="gov-tab active" href="/ops/preflight-review.php">Προπτήση</a><a class="gov-tab" href="/ops/test-session.php">Συνεδρία</a><a class="gov-tab" href="/ops/evidence-bundle.php">Αποδείξεις</a><a class="gov-tab" href="/ops/evidence-report.php">Αναφορά</a></div>
        </div>
