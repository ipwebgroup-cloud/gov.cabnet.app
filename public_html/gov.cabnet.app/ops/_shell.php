<?php
/**
 * gov.cabnet.app — shared operations UI shell v3.2.5
 *
...
<div class="gov-shell">
    <aside class="gov-sidebar">
        ...
        <div class="gov-side-note">V3 observation toolchain through v3.2.5 is installed: real-mail candidate capture, watch snapshot, evidence snapshot, EDXEIX dry-run preview, expired candidate safety regression audit, and controlled live-submit readiness checklist are available. Routes were not deleted; developer routes are grouped under Developer Archive. Live EDXEIX submission remains blocked.</div>
    </aside>
