...
<div class="gov-shell">
    <aside class="gov-sidebar">
        ...
        <div class="gov-side-group"><div class="gov-side-group-title">Administration</div><a class="gov-side-link active" href="/ops/admin-control.php">Admin Control</a><a class="gov-side-link" href="/ops/readiness-control.php">Readiness Control</a><a class="gov-side-link" href="/ops/mapping-control.php">Mapping Review</a><a class="gov-side-link" href="/ops/jobs-control.php">Jobs Review</a><div class="gov-side-group-title">Workflow</div><a class="gov-side-link" href="/ops/test-session.php">Test Session</a><a class="gov-side-link" href="/ops/dev-accelerator.php">Dev Accelerator</a><a class="gov-side-link" href="/ops/preflight-review.php">Preflight Review</a><a class="gov-side-link" href="/ops/evidence-bundle.php">Evidence Bundle</a><a class="gov-side-link" href="/ops/evidence-report.php">Evidence Report</a></div>
    ...
    <div class="gov-content">
        <div class="gov-page-header">
            ...
            <div class="gov-tabs"><a class="gov-tab active" href="/ops/admin-control.php">Καρτέλα</a><a class="gov-tab" href="/ops/test-session.php">Test Session</a><a class="gov-tab" href="/ops/preflight-review.php">Preflight</a></div>
        </div>
...
<section class="card hero">
    ...
    <p>EDXEIX-style control entry point for readiness, mapping review, and local jobs visibility.</p>
    <div>
...
<section class="gov-admin-grid">
    ...
    <a class="gov-admin-link" href="/ops/evidence-report.php"><strong>Evidence Report</strong><span>Copy/paste Markdown evidence export.</span></a>
</section>
        </main>
    </div>
</div>
