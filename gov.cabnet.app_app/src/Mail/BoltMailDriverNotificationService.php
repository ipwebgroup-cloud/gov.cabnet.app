...
final class BoltMailDriverNotificationService
{
    ...
    private function sendReceiptEmail(string $recipient, string $subject, int $intakeId, array $row, string $fromEmail, string $fromName): array
    {
        ...
        // Backward-compatible fallback only. Production receipt legitimacy should
        // come from an official PDF attachment generated by the invoicing system.
    ...
    private function sendReceiptEmailWithPdfAttachment(
        ...
        $headers = $this->buildMultipartHeaders($fromEmail, $fromName, $boundary, 'bolt-mail-driver-official-receipt-pdf');
