<?php
/**
 * gov.cabnet.app — Maildir pre-ride email loader.
 *
 * Purpose:
 * - Read the latest matching Bolt pre-ride email from server-side cPanel Maildir.
 * - Return the decoded body to the manual parser.
 *
 * Safety:
...
final class MaildirPreRideEmailLoader
{
    private const MAX_FILE_BYTES = 250000;
    private const MAX_FILES_PER_DIR = 60;
    ...
    private function candidateDirs(array $extraDirs): array
    {
        ...
        $env = getenv('GOV_CABNET_PRERIDE_MAILDIR');
