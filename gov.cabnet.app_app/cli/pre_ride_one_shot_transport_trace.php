...
<?php
/**
 * gov.cabnet.app — CLI supervised pre-ride one-shot EDXEIX transport trace v3.2.30.
 * Default is dry-run/armable packet. Actual HTTP POST requires --transport=1,
...
foreach (array_slice($argv, 1) as $arg) {
    ...
    if ($arg === '--help' || $arg === '-h') {
        ...
        echo "\nDefault is dry-run/armable packet. Transport performs one HTTP POST trace.\n";
        exit(0);
    }
}
